...
class DiagnosisBase(BaseModel):
    ...
    patient_id: Annotated[str, Field(min_length=1, max_length=36, description="Patient ID")]
    ...
    description: str | None = Field(default=None, max_length=1000, description="Additional notes")
...
class DiagnosisUpdate(BaseModel):
    ...
    diagnosis_code: str | None = Field(default=None, max_length=50, description="Diagnosis code")
    diagnosis_name: str | None = Field(default=None, max_length=255, description="Diagnosis name")
    description: str | None = Field(default=None, max_length=1000, description="Additional notes")
