...
from core.PHASE_2.providers import (
    BaseProvider,
    ProviderRegistry,
    ProviderSelector,
    ProviderManager,
...
from core.PHASE_2.providers.types import GenerationRequest
from core.PHASE_2.providers.exceptions import ProviderUnavailableError
...
class MockProvider(BaseProvider):
    ...
    def generate(self, request):
        from core.PHASE_2.providers.types import GenerationResponse
