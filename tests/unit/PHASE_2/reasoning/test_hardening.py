...
class TestCapabilityRegistration:
    ...
    def test_capability_registrar(self) -> None:
        ...
        from core.PHASE_2.reasoning.reasoning_engine import ReasoningCapabilityRegistrar
...
class TestEventBusIntegration:
    ...
    def test_event_publisher_disabled_without_bus(self) -> None:
        ...
        from core.PHASE_2.reasoning.reasoning_engine import ReasoningEventPublisher
