...
class TestCognitiveEvents:
    ...
    def test_event_history(self):
        ...
        from core.pipeline.cognitive_events import CognitiveEvent, CognitiveEventType
...
class TestCognitiveStages:
    ...
    def test_intent_detection_query(self):
        ...
        from core.pipeline.stages import IntentDetectionStage
    ...
    def test_context_building(self):
        """Test context building stage."""
        from core.pipeline.stages import ContextBuildingStage
