...
class TestConfidenceCalculators:
    ...
    def test_default_calculator(self) -> None:
        ...
        from core.reasoning.confidence_model import DefaultConfidenceCalculator
        from core.reasoning.reasoning_types import Hypothesis
    ...
    def test_factory(self) -> None:
        ...
        from core.reasoning.confidence_model import ConfidenceCalculatorFactory
