...
from core.PHASE_2.execution.types import ComponentStatus, ValidationResult
...
class ExecutionValidator:
    ...
    def check_router_available(self) -> ComponentStatus:
        ...
        from core.PHASE_2.router import get_routing_registry
    ...
    def check_pipeline_available(self) -> ComponentStatus:
        ...
        try:
            ...
            from core.PHASE_2.pipeline.stage import PlanningStage
            stage = PlanningStage()
    ...
    def check_session_manager_available(self) -> ComponentStatus:
        ...
        try:
            from core.PHASE_2.session import get_session_manager
    ...
    def check_event_bus_available(self) -> ComponentStatus:
        ...
        try:
            from core.PHASE_1.infrastructure.events import get_global_bus
