...
from core.PHASE_2.embeddings.exceptions import SelectionError
from core.PHASE_2.embeddings.provider import BaseEmbeddingProvider
from core.PHASE_2.embeddings.registry import EmbeddingRegistry
...
class EmbeddingSelector:
    ...
    def registry(self) -> EmbeddingRegistry:
        ...
        if self._registry is None:
            from core.PHASE_2.embeddings import get_embedding_registry
