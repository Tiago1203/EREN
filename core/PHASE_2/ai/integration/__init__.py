...
from core.PHASE_2.ai.integration.uow_factory import (
    AIUnitOfWork,
    AIUnitOfWorkFactory,
    get_uow_factory,
    set_uow_factory,
...
from core.PHASE_2.ai.integration.domain_adapter import (
...
from core.PHASE_2.ai.integration.memory_bridge import (
    EntityType,
    DomainReference,
...
from core.PHASE_2.ai.integration.event_bridge import (
    AIEventType,
    AIEvent,
    DomainEventType,
    EventBridge,
...
def setup_integration(
    ...
    from core.PHASE_2.ai.memory import get_memory_manager
