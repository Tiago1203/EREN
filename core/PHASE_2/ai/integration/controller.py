...
from core.PHASE_2.ai.memory import MemoryManager
from core.PHASE_2.ai.prompt import PromptBuilder, PromptConfig
...
from core.PHASE_2.ai.sessions import SessionManager, Session, ConversationLimit
from core.PHASE_2.ai.tools import ToolOrchestrator, ToolDefinition

from core.PHASE_2.ai.integration.models import (
    AICoreConfig,
    AICoreMetrics,
    AICoreStats,
    AICoreStatus,
...
class AICoreController:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            from core.PHASE_2.ai.context_builder.providers import (
                get_providers_with_gateways,
                providers_to_sources,
            )
            from core.PHASE_2.ai.context_builder.models import ContextSource
    ...
    async def _build_context(
        ...
        from core.PHASE_2.ai.context_builder.models import ContextQuery, ContextSource
