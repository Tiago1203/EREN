...
# EPIC 0 - AI Foundation
from core.PHASE_2.ai.kernel import AIKernel, get_kernel, shutdown_kernel, reset_kernel
from core.PHASE_2.ai.config import AIConfiguration, DictAIConfiguration, FileAIConfiguration
...
from core.PHASE_2.ai.di import get_container, set_container, reset_container
...
from core.PHASE_2.ai.registry import ModelRegistry, ProviderRegistry

# EPIC 1 - Conversation
from core.PHASE_2.ai.conversation import (
...
from core.PHASE_2.ai.prompt.renderer import PromptRenderer
from core.PHASE_2.ai.prompt.optimizer import PromptOptimizer
from core.PHASE_2.ai.prompt.strategy import (
    DirectStrategy,
    ChainOfThoughtStrategy,
    FewShotStrategy,
    TreeOfThoughtStrategy,
)
from core.PHASE_2.ai.prompt.versioning import PromptVersion, PromptVersioningManager

# EPIC 4 - Memory Manager
from core.PHASE_2.ai.memory import (
    MemoryManager,
    MemoryItem,
    MemoryType,
    MemoryRepository,
...
from core.PHASE_2.ai.memory.repository import MemoryRepository
...
# EPIC 9 - AI Integration
from core.PHASE_2.ai.integration import (
    AICoreController,
    AICoreConfig,
    AICoreMetrics,
    AICoreStats,
