...
if TYPE_CHECKING:
    from core.PHASE_1.domain.incident.domain.repositories import IncidentRepository
...
class IncidentGateway(IIncidentGateway):
    ...
    async def get_by_id(
        ...
        from core.PHASE_1.infrastructure.shared import IncidentId, TenantId
    ...
    async def get_by_device(
        ...
        from core.PHASE_1.infrastructure.shared import DeviceId, TenantId
    ...
    async def get_by_engineer(
        ...
        from core.PHASE_1.infrastructure.shared import EngineerId, TenantId
