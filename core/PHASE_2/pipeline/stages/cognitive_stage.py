...
from core.PHASE_2.pipeline.types import StageMetadata, StageResult, StageState
...
class CognitiveStage(PipelineStage, ABC):
    ...
    def __init__(
        ...
        """
        from core.PHASE_2.pipeline.types import StageType
    ...
    def execute(self, context: PipelineContext) -> StageResult:
        ...
        """
        from core.PHASE_2.pipeline.types import StageState
    ...
    def _create_event(
        ...
        Returns:
            Cognitive event.
        """
        from core.PHASE_2.pipeline.cognitive_events import CognitiveEvent
