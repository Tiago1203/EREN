...
from core.PHASE_2.learning.consolidation import (
...
# Components
from core.PHASE_2.learning.experience import (
    ExperienceCollector,
    get_experience_collector,
    reset_experience_collector,
)
from core.PHASE_2.learning.feedback import (
    FeedbackAnalyzer,
    get_feedback_analyzer,
    reset_feedback_analyzer,
)
from core.PHASE_2.learning.optimizer import (
    StrategyOptimizer,
    get_strategy_optimizer,
    reset_strategy_optimizer,
)
from core.PHASE_2.learning.patterns import (
    PatternDiscovery,
...
# Main platform
from core.PHASE_2.learning.platform import (
