...
from core.PHASE_2.reasoning.adapters import (
    ReasoningContextAdapter,
    ReasoningMemoryAdapter,
)
from core.PHASE_2.reasoning.capabilities import get_reasoning_capabilities
from core.PHASE_2.reasoning.confidence_engine import (
    ConfidenceEngine,
    get_confidence_engine,
    reset_confidence_engine,
)
from core.PHASE_2.reasoning.confidence_model import (
...
from core.PHASE_2.reasoning.decision_composer import (
    DecisionComposer,
    get_decision_composer,
    reset_decision_composer,
)
from core.PHASE_2.reasoning.evidence_engine import (
    EvidenceEngine,
    get_evidence_engine,
    reset_evidence_engine,
)
from core.PHASE_2.reasoning.evidence_manager import EvidenceManager
from core.PHASE_2.reasoning.exceptions import (
    ChainNotFoundError,
...
from core.PHASE_2.reasoning.explanation_engine import (
    ExplanationEngine,
    get_explanation_engine,
    reset_explanation_engine,
)
from core.PHASE_2.reasoning.hypothesis_manager import HypothesisManager

# Reasoning Platform Components
from core.PHASE_2.reasoning.inference import (
    InferenceEngine,
    get_inference_engine,
    reset_inference_engine,
)
from core.PHASE_2.reasoning.reasoning_chain import (
    ReasoningChain,
    ReasoningChainBuilder,
    ReasoningChainManager,
)
from core.PHASE_2.reasoning.reasoning_engine import (
    CognitiveReasoningEngine,
    ReasoningCapabilityRegistrar,
    ReasoningEventPublisher,
    ReasoningSession,
)
from core.PHASE_2.reasoning.reasoning_events import ReasoningEvent
from core.PHASE_2.reasoning.reasoning_events import ReasoningEventPublisher as LegacyEventPublisher
from core.PHASE_2.reasoning.reasoning_metrics import (
    ReasoningHealthCheck,
    ReasoningMetrics,
    ReasoningMetricsCollector,
)
from core.PHASE_2.reasoning.reasoning_strategy import (
...
from core.PHASE_2.reasoning.reasoning_trace import ReasoningTrace, ReasoningTraceBuilder
...
from core.PHASE_2.reasoning.reflection_engine import (
    ReflectionEngine,
    get_reflection_engine,
    reset_reflection_engine,
)
from core.PHASE_2.reasoning.validation_engine import (
    ValidationEngine,
