...
from core.LEGACY.collaboration.aggregator import get_result_aggregator
from core.LEGACY.collaboration.communication_bus import (
    get_communication_bus,
)
from core.LEGACY.collaboration.consensus import get_consensus_manager
from core.LEGACY.collaboration.dispatcher import get_task_dispatcher
from core.LEGACY.collaboration.protocol import (
    CommunicationPattern,
    MessageBuilder,
)
from core.LEGACY.collaboration.resolver import get_conflict_resolver
from core.LEGACY.collaboration.sessions import (
    get_session_manager,
)
from core.LEGACY.collaboration.shared_context import get_shared_context
...
class CoordinationEngine:
    ...
    def vote(self, proposal_id: str, agent_id: str, vote: str) -> bool:
        """Vote on a proposal."""
        from core.LEGACY.collaboration.types import VoteValue
