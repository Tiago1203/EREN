...
from core.PHASE_1.infrastructure.lifecycle.lifecycle_trace import LifecycleTraceCollector
from core.PHASE_1.infrastructure.lifecycle.lifecycle_types import VALID_TRANSITIONS
