...
if TYPE_CHECKING:
    from core.PHASE_1.infrastructure.diagnostics.architecture import ArchitectureReport
    from core.PHASE_1.infrastructure.diagnostics.contracts import ContractReport
    from core.PHASE_1.infrastructure.diagnostics.dependencies import DependencyReport
    from core.PHASE_1.infrastructure.diagnostics.health import HealthCheckResult
    from core.PHASE_1.infrastructure.diagnostics.integration import IntegrationReport
    from core.PHASE_1.infrastructure.diagnostics.liveness import LivenessReport
    from core.PHASE_1.infrastructure.diagnostics.performance import PerformanceReport
    from core.PHASE_1.infrastructure.diagnostics.readiness import ReadinessReport
    from core.PHASE_1.infrastructure.diagnostics.runtime import RuntimeReport
