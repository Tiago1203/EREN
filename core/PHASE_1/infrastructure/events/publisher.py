...
if TYPE_CHECKING:
    ...
    from core.PHASE_1.infrastructure.events.models import Event, EventType
...
class EventPublisherMixin:
    ...
    def event_bus(self) -> EventBus:
        ...
        if self._event_bus is None:
            from core.PHASE_1.infrastructure.events.bus import get_global_bus
    ...
    def publish(
        ...
        **payload: object,
        ...
        """
        from core.PHASE_1.infrastructure.events.models import create_event
