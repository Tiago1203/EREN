...
from core.cognitive.conversation.infrastructure.redis_store import RedisConversationStore
...
class ConversationController:
    ...
    async def send_message(
        ...
        # Get AI response
        from core.cognitive.runtime import ProcessingContext
...
def create_conversation_controller(
    ...
    from core.cognitive.conversation.infrastructure.redis_store import create_redis_conversation_store
