...
if TYPE_CHECKING:
    from core.providers.health_monitor import HealthMetrics
    from core.providers.provider import BaseProvider
    from core.providers.types import ProviderCapabilities, SelectionCriteria
...
class ScoringEngine:
    ...
    def _score_availability(
        ...
        Returns:
            Score between 0 and 1.
        """
        from core.providers.types import ProviderState
