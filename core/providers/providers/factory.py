...
from core.providers.types import ProviderConfig, ProviderType
...
def AnthropicProvider():
    ...
    from core.providers.providers.anthropic_provider import AnthropicProvider as _Impl
    return _Impl()


def GeminiProvider():
    """Create Gemini provider (placeholder)."""
    from core.providers.providers.gemini_provider import GeminiProvider as _Impl
    return _Impl()


def AzureOpenAIProvider():
    """Create Azure OpenAI provider (placeholder)."""
    from core.providers.providers.azure_provider import AzureOpenAIProvider as _Impl
    return _Impl()


def DeepSeekProvider():
    """Create DeepSeek provider (placeholder)."""
    from core.providers.providers.deepseek_provider import DeepSeekProvider as _Impl
    return _Impl()


def MistralProvider():
    """Create Mistral provider (placeholder)."""
    from core.providers.providers.mistral_provider import MistralProvider as _Impl
    return _Impl()


def OpenRouterProvider():
    """Create OpenRouter provider (placeholder)."""
    from core.providers.providers.openrouter_provider import OpenRouterProvider as _Impl
    return _Impl()
