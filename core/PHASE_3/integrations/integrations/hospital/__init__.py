...
from core.PHASE_3.integrations.hospital.fhir import (
    FHIRClient,
    FHIRDevice,
    FHIRPatient,
    FHIRObservation,
...
from core.PHASE_3.integrations.hospital.hl7 import (
    HL7Listener,
    HL7Message,
    HL7Parser,
    HL7Segment,
...
from core.PHASE_3.integrations.hospital.dicom import (
    DICOMClient,
    DICOMPatient,
    DICOMStudy,
    DICOMSeries,
