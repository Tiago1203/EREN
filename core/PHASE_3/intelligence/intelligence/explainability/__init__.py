...
ARCHITECTURE NOTE:
LanguageStyle is imported from core.PHASE_3.intelligence.foundation.enums to ensure consistency.
...
from core.PHASE_3.intelligence.foundation.enums import LanguageStyle
