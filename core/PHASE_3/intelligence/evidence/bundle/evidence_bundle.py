...
ARCHITECTURE NOTE:
ComplianceStatus is imported from core.PHASE_3.intelligence.foundation.enums to ensure consistency.
...
from core.PHASE_3.intelligence.foundation.enums import ComplianceStatus
