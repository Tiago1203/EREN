...
from core.ai.memory.models import MemoryItem, MemoryQuery, MemoryType

if TYPE_CHECKING:
    from core.ai.memory.models import MemoryResult, MemorySummary
...
class InMemoryMemoryRepository(MemoryRepository):
    ...
    def get_summary(self, tenant_id: str) -> MemorySummary:
        """Obtiene resumen de memorias."""
        from core.ai.memory.models import MemoryImportance, MemorySummary
